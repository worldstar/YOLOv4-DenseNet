...
def _main():
    ...
    # print('RQWEWQEQWE',len(anchors))
    if is_tiny_version:
        model = create_tiny_model(input_shape, anchors, num_classes,
            freeze_body=2, weights_path='model_data/tiny_yolo_weights.h5')
    else:
        model = create_model(input_shape, anchors, num_classes,
            freeze_body=2,load_pretrained=False, weights_path='model_data/dense121_weights.h5') # make sure you know what you freeze
